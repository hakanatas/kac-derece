...
//   npm run bundle   → dist/kac-derece.html  (easy to email, put on a USB stick, or host)
...
fs.writeFileSync(path.join(root, 'dist', 'kac-derece.html'), html);
console.log('✓ dist/kac-derece.html', (html.length / 1024).toFixed(0) + ' KB');
...
fs.writeFileSync(path.join(root, 'dist', 'kac-derece.artifact.html'), art);
console.log('✓ dist/kac-derece.artifact.html');
